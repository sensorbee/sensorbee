...
func TestArraySlicing(t *testing.T) {
	...
	Convey("Slicing should mostly behave like Python", t, func() {
		examples := map[string]interface{}{
			...
			"foo[-4:-3]": Array{},
			"foo[-4:-2]": Array{elem0},
			"foo[-4:-1]": Array{elem0, elem1},
			"foo[-4:0]":  Array{}, // this is always empty
			"foo[-4:1]":  Array{elem0},
			"foo[-4:2]":  Array{elem0, elem1},
			"foo[-4:3]":  Array{elem0, elem1, elem2},
			"foo[-4:4]":  Array{elem0, elem1, elem2},
			"foo[-3:-2]": Array{elem0},
			"foo[-3:-1]": Array{elem0, elem1},
			"foo[-3:0]":  Array{},
			"foo[-3:1]":  Array{elem0},
			"foo[-3:2]":  Array{elem0, elem1},
			"foo[-3:3]":  Array{elem0, elem1, elem2},
			"foo[-3:4]":  Array{elem0, elem1, elem2},
			"foo[-2:-1]": Array{elem1},
			"foo[-2:0]":  Array{},
			"foo[-2:1]":  Array{},
			"foo[-2:2]":  Array{elem1},
			"foo[-2:3]":  Array{elem1, elem2},
			"foo[-2:4]":  Array{elem1, elem2},
			"foo[-1:0]":  Array{},
			"foo[-1:1]":  Array{},
			"foo[-1:2]":  Array{},
			"foo[-1:3]":  Array{elem2},
			...
			"foo[0:-3]":  Array{},
			"foo[0:-2]":  Array{elem0},
			"foo[0:-1]":  Array{elem0, elem1},
			"foo[0:1]":   Array{elem0},
			"foo[0:2]":   Array{elem0, elem1},
			"foo[0:3]":   Array{elem0, elem1, elem2},
			"foo[0:4]":   Array{elem0, elem1, elem2},
			"foo[1:-4]":  Array{},
			"foo[1:-3]":  Array{},
			"foo[1:-2]":  Array{},
			"foo[1:-1]":  Array{elem1},
			...
			"foo[-4:-3:1]": Array{},
			"foo[-4:-3:2]": Array{},
			"foo[-4:-2:1]": Array{elem0},
			"foo[-4:-2:2]": Array{elem0},
			"foo[-4:-1:1]": Array{elem0, elem1},
			"foo[-4:-1:2]": Array{elem0},
			"foo[-4:0:1]":  Array{},
			"foo[-4:0:2]":  Array{},
			"foo[-4:1:1]":  Array{elem0},
			"foo[-4:1:2]":  Array{elem0},
			"foo[-4:2:1]":  Array{elem0, elem1},
			"foo[-4:2:2]":  Array{elem0},
			"foo[-4:3:1]":  Array{elem0, elem1, elem2},
			"foo[-4:3:2]":  Array{elem0, elem2},
			"foo[-4:4:1]":  Array{elem0, elem1, elem2},
			"foo[-4:4:2]":  Array{elem0, elem2},

			"foo[-3:-2:1]": Array{elem0},
			"foo[-3:-2:2]": Array{elem0},
			"foo[-3:-1:1]": Array{elem0, elem1},
			"foo[-3:-1:2]": Array{elem0},
			"foo[-3:0:1]":  Array{},
			"foo[-3:0:2]":  Array{},
			"foo[-3:1:1]":  Array{elem0},
			"foo[-3:1:2]":  Array{elem0},
			"foo[-3:2:1]":  Array{elem0, elem1},
			"foo[-3:2:2]":  Array{elem0},
			"foo[-3:3:1]":  Array{elem0, elem1, elem2},
			"foo[-3:3:2]":  Array{elem0, elem2},
			"foo[-3:4:1]":  Array{elem0, elem1, elem2},
			"foo[-3:4:2]":  Array{elem0, elem2},

			"foo[-2:-1:1]": Array{elem1},
			"foo[-2:-1:2]": Array{elem1},
			"foo[-2:0:1]":  Array{},
			"foo[-2:0:2]":  Array{},
			"foo[-2:1:1]":  Array{},
			"foo[-2:1:2]":  Array{},
			"foo[-2:2:1]":  Array{elem1},
			"foo[-2:2:2]":  Array{elem1},
			"foo[-2:3:1]":  Array{elem1, elem2},
			"foo[-2:3:2]":  Array{elem1},
			"foo[-2:4:1]":  Array{elem1, elem2},
			"foo[-2:4:2]":  Array{elem1},
			...
			"foo[-1:2:1]": Array{},
			"foo[-1:2:2]": Array{},
			"foo[-1:3:1]": Array{elem2},
			"foo[-1:3:2]": Array{elem2},
			"foo[-1:4:1]": Array{elem2},
			"foo[-1:4:2]": Array{elem2},

			"foo[0:-4:1]": Array{},
			"foo[0:-4:2]": Array{},
			"foo[0:-3:1]": Array{},
			"foo[0:-3:2]": Array{},
			"foo[0:-2:1]": Array{elem0},
			"foo[0:-2:2]": Array{elem0},
			"foo[0:-1:1]": Array{elem0, elem1},
			"foo[0:-1:2]": Array{elem0},
			"foo[0:1:1]":  Array{elem0},
			"foo[0:1:2]":  Array{elem0},
			"foo[0:2:1]":  Array{elem0, elem1},
			"foo[0:2:2]":  Array{elem0},
			"foo[0:3:1]":  Array{elem0, elem1, elem2},
			"foo[0:3:2]":  Array{elem0, elem2},
			"foo[0:4:1]":  Array{elem0, elem1, elem2},
			"foo[0:4:2]":  Array{elem0, elem2},
			...
			"foo[1:-2:1]": Array{},
			"foo[1:-2:2]": Array{},
			"foo[1:-1:1]": Array{elem1},
			"foo[1:-1:2]": Array{elem1},
			"foo[1:2:1]":  Array{elem1},
			"foo[1:2:2]":  Array{elem1},
			"foo[1:3:1]":  Array{elem1, elem2},
			"foo[1:3:2]":  Array{elem1},
			"foo[1:4:1]":  Array{elem1, elem2},
			"foo[1:4:2]":  Array{elem1},
			...
			"foo[2:-1:1]": Array{},
			"foo[2:-1:2]": Array{},
			"foo[2:3:1]":  Array{elem2},
			"foo[2:3:2]":  Array{elem2},
			"foo[2:4:1]":  Array{elem2},
			"foo[2:4:2]":  Array{elem2},
			...
			"foo[-3:-4:-2]": Array{elem0},
			"foo[-3:-4:-1]": Array{elem0},
			"foo[-3:0:-2]":  Array{},
			"foo[-3:0:-1]":  Array{},
			"foo[-3:1:-2]":  Array{},
			"foo[-3:1:-1]":  Array{},
			...
			"foo[-2:-4:-2]": Array{elem1},
			"foo[-2:-4:-1]": Array{elem1, elem0},
			"foo[-2:-3:-2]": Array{elem1},
			"foo[-2:-3:-1]": Array{elem1},
			"foo[-2:0:-2]":  Array{elem1},
			"foo[-2:0:-1]":  Array{elem1},
			"foo[-2:1:-2]":  Array{},
			"foo[-2:1:-1]":  Array{},
			"foo[-2:2:-2]":  Array{},
			"foo[-2:2:-1]":  Array{},
			...
			"foo[-1:-4:-2]": Array{elem2, elem0},
			"foo[-1:-4:-1]": Array{elem2, elem1, elem0},
			"foo[-1:-3:-2]": Array{elem2},
			"foo[-1:-3:-1]": Array{elem2, elem1},
			"foo[-1:-2:-2]": Array{elem2},
			"foo[-1:-2:-1]": Array{elem2},
			"foo[-1:0:-2]":  Array{elem2},
			"foo[-1:0:-1]":  Array{elem2, elem1},
			"foo[-1:1:-2]":  Array{elem2},
			"foo[-1:1:-1]":  Array{elem2},
			"foo[-1:2:-2]":  Array{},
			"foo[-1:2:-1]":  Array{},
			"foo[-1:3:-2]":  Array{},
			"foo[-1:3:-1]":  Array{},
			...
			"foo[0:-4:-2]": Array{elem0},
			"foo[0:-4:-1]": Array{elem0},
			"foo[0:-3:-2]": Array{},
			"foo[0:-3:-1]": Array{},
			"foo[0:-2:-2]": Array{},
			"foo[0:-2:-1]": Array{},
			...
			"foo[1:-4:-2]": Array{elem1},
			"foo[1:-4:-1]": Array{elem1, elem0},
			"foo[1:-3:-2]": Array{elem1},
			"foo[1:-3:-1]": Array{elem1},
			"foo[1:-2:-2]": Array{},
			"foo[1:-2:-1]": Array{},
			"foo[1:-1:-2]": Array{},
			"foo[1:-1:-1]": Array{},
			"foo[1:0:-2]":  Array{elem1},
			"foo[1:0:-1]":  Array{elem1},

			"foo[2:-4:-2]": Array{elem2, elem0},
			"foo[2:-4:-1]": Array{elem2, elem1, elem0},
			"foo[2:-3:-2]": Array{elem2},
			"foo[2:-3:-1]": Array{elem2, elem1},
			"foo[2:-2:-2]": Array{elem2},
			"foo[2:-2:-1]": Array{elem2},
			"foo[2:-1:-2]": Array{},
			"foo[2:-1:-1]": Array{},
			"foo[2:0:-2]":  Array{elem2},
			"foo[2:0:-1]":  Array{elem2, elem1},
			"foo[2:1:-2]":  Array{elem2},
			"foo[2:1:-1]":  Array{elem2},

			"foo[3:-4:-2]": Array{elem2, elem0},
			"foo[3:-4:-1]": Array{elem2, elem1, elem0},
			"foo[3:-3:-2]": Array{elem2},
			"foo[3:-3:-1]": Array{elem2, elem1},
			"foo[3:-2:-2]": Array{elem2},
			"foo[3:-2:-1]": Array{elem2},
			"foo[3:-1:-2]": Array{},
			"foo[3:-1:-1]": Array{},
			"foo[3:0:-2]":  Array{elem2},
			"foo[3:0:-1]":  Array{elem2, elem1},
			"foo[3:1:-2]":  Array{elem2},
			"foo[3:1:-1]":  Array{elem2},
			"foo[3:2:-2]":  Array{},
			"foo[3:2:-1]":  Array{},

			"foo[4:-4:-2]": Array{elem2, elem0},
			"foo[4:-4:-1]": Array{elem2, elem1, elem0},
			"foo[4:-3:-2]": Array{elem2},
			"foo[4:-3:-1]": Array{elem2, elem1},
			"foo[4:-2:-2]": Array{elem2},
			"foo[4:-2:-1]": Array{elem2},
			"foo[4:-1:-2]": Array{},
			"foo[4:-1:-1]": Array{},
			"foo[4:0:-2]":  Array{elem2},
			"foo[4:0:-1]":  Array{elem2, elem1},
			"foo[4:1:-2]":  Array{elem2},
			"foo[4:1:-1]":  Array{elem2},
			"foo[4:2:-2]":  Array{},
			"foo[4:2:-1]":  Array{},
			"foo[4:3:-2]":  Array{},
			"foo[4:3:-1]":  Array{},
			...
			// no end given
			"foo[-4:]": Array{elem0, elem1, elem2},
			"foo[-3:]": Array{elem0, elem1, elem2},
			"foo[-2:]": Array{elem1, elem2},
			"foo[-1:]": Array{elem2},
			"foo[0:]":  Array{elem0, elem1, elem2},
			"foo[1:]":  Array{elem1, elem2},
			"foo[2:]":  Array{elem2},
			...
			"foo[:-3]": Array{}, // this is empty for lists with < 4 elements
			"foo[:-2]": Array{elem0},
			"foo[:-1]": Array{elem0, elem1},
			"foo[:0]":  Array{}, // this is always empty
			"foo[:1]":  Array{elem0},
			"foo[:2]":  Array{elem0, elem1},
			"foo[:3]":  Array{elem0, elem1, elem2},
			"foo[:4]":  Array{elem0, elem1, elem2},
